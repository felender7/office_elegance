<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1.Master" AutoEventWireup="true" CodeBehind="VirtualElegance.aspx.cs" Inherits="Office_Elegence.pages.virtualOffice.VirtualElegance" %>
...
<div class="container ">
   ...
   <div class="text-center"><h3 style="margin-top: 2px;">Virtual Elegance - Online Application Form</h3></div>
    <hr />
    <div class="row  ">
...
12. A once-off registration fee of R350.00 is to be paid with the registration of the package .The amount of R995.00 is to be paid on or before the 30th of every month. Any payment not received by the 7th of each month will be regarded as late payment. 
