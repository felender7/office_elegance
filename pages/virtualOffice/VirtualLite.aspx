<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1.Master" AutoEventWireup="true" CodeBehind="VirtualLite.aspx.cs" Inherits="Office_Elegence.pages.virtualOffice.VirtualLite" %>
...
<div class="container ">
   ...
   <div class="text-center"><h3 style="margin-top: 2px;">Virtual Lite - Online Application Form</h3></div>
    <hr />
    <div class="row  ">
...
2. Office Elegance will supply services to the client as mentioned in Annexure A for as long as is stipulated in this agreement and client makes payments monthly as stipulated in this contract. 
3. Office Elegance reserves the right to cancel the contract if the need arises, with a reasonable motive. 
4. The telephone numbers supplied by Office Elegance remain the property of Office Elegance once the contract dissolves, and Office Elegance ceases to supply services to the client. 
5. Office Elegance cannot be held responsible for any loss (financial or loss of property) on the premises resulting from fraud, theft, power failures, internet connection failures , network failures, mobile services and telephone line failure. 
6. Office Elegance undertakes to treat and safeguard all confidential documentation disclosed to it, and not to use the information thereof, either directly or indirectly, except if the client gives consent to use such information. 
7. A once-off registration fee of R350.00 is to be paid with the registration of the package .The amount of R350.00 is to be paid on or before the 30th of every month. Any payment not received by the 7th of each month will be regarded as late payment. 
8. A late penalty of R100.00 will be charged for any late payments i.e. outstanding amounts not paid by the 8th of every month. 

9. All payment should be made to the following account: 
