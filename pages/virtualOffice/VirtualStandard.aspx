<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1.Master" AutoEventWireup="true" CodeBehind="VirtualStandard.aspx.cs" Inherits="Office_Elegence.pages.virtualOffice.VirtualStandard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="text-center"><h3 style="margin-top: 2px;">Virtual Standard - Online Application Form</h3></div>
    <hr />
    <div class="row  ">
...
2. The time in hours as stated in clause 2 of Annexure A, may not lapse to the next calendar month. Any hours not used in that month will be forfeited at the end of the specific month. 
3. Boardroom bookings at Office Elegance will need to be made 24 hours in advance. Office Elegance may not be held responsible for boardroom unavailability due to late bookings. 
4. Office Elegance will supply services to the client as mentioned in Annexure A for as long as is stipulated in this agreement and client makes payments monthly as stipulated in this contract. 
5. Office Elegance reserves the right to cancel the contract if the need arises, with a reasonable motive. 
6. The telephone numbers supplied by Office Elegance remain the property of Office Elegance once the contract dissolves, and Office Elegance ceases to supply services to the client. 
7. When the client ceases to use the services of Office Elegance, the client will be required to change the business address to the new location where the client will be based. Any mail belonging to the client that still arrives at 155 Rivier Street, Pretoria, 0002 after the contract dissolves, will be disposed of. 
8. Office Elegance cannot be held responsible for any loss (financial or loss of property) on the premises resulting from fraud, theft, power failures, internet connection failures , network failures, mobile services and telephone line failure. 
9. Office Elegance undertakes to treat and safeguard all confidential documentation disclosed to it, and not to use the information thereof, either directly or indirectly, except if the client gives consent to use such information. 
10. A once-off registration fee of R350.00 is to be paid with the registration of the package .The amount of R590.00 is to be paid on or before the 30th of every month. Any payment not received by the 7th of each month will be regarded as late payment. 
11. A late penalty of R100.00 will be charged for any late payments i.e. outstanding amounts not paid by the 8th of every month. 


12. All payment should be made to the following account: 
